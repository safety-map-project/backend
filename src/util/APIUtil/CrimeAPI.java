...
public class CrimeAPI {
	...
	// crime api url
	private static final String CRIME_API_URL = "http://apis.data.go.kr/B554626/CrimeAnalysis/getCrimeAnalysis?serviceKey=bafEXsp3A%2FiNM6SrdTReCSgGSp3PZcxqoiD08onBtPTnKgLGfaCfkXnJa15dbR8zVjWpmN99qG5QMrpT%2FjWbuQ%3D%3D&type=JSON&sht=T188653019959688&statsYr=2023&artcl=B001,B002,B003,B004,B005,B006,B007,B008,B009,B010,B011,B012,B013,B020,B021,B022,B023,B024,B025,B026,B027,B028,B029,B030,B031,B032,B033,B034,B035,B036,B037,B038,B039,B040,B041,B042,B044,B045,B046,B047,B048,B049,B050,B051,B054,B055,B056,B057,B058,B059,B060,B061,B062,B065,B066,B067,B068,B069,B070,B071,B072,B073,B074,B075,B076,B077,B078,B079,B080,B081";
	...
	private static List<Crime> setCrimeRegionName(JsonArray cityNameArray, List<Crime> crimeHeinousList, List<Crime> crimeAttackList){
		...
		setRegionnameAddGu(crimeHeinousList);
		setRegionnameAddGu(crimeAttackList);
	...
	private static void setRegionnameAddGu(List<Crime> crimeList) {
		for(Crime crime : crimeList) {
			if(!crime.getRegion().contains("구") || crime.getRegion().contains("수성") || crime.getRegion().contains("달서") ) {
				crime.setRegion(crime.getRegion() + "구");
			}
		}
	}
